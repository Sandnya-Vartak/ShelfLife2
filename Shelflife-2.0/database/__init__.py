    ...
    with application.app_context():
        ...
        try:
            with engine.connect() as conn:
                ...
                if "last_emailed_at" not in notification_columns:
                    add_column("shelflife_notifications", "last_emailed_at DATETIME NULL")

                if "wasted_at" not in notification_columns:
                    add_column("shelflife_notifications", "wasted_at DATETIME NULL")
