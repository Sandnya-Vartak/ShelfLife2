...
def serialize_notification(notification):
    return {
        ...
        'wasted_at': notification.wasted_at.isoformat() if getattr(notification, 'wasted_at', None) else None,
    }
...
def send_notification_email():
    ...
    reason_messages = {
        'no_notifications': 'No urgent or overdue items found, so no email was sent.',
        'already_sent_today': 'Today\'s reminder was already sent for all current expiring items.',
